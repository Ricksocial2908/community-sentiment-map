...
import { getTokyoDetailedInfo } from "@/data/regions/asiaPacific";
import { getIrelandDetailedInfo } from "@/data/regions/europe";
import { getVirginiaDetailedInfo, getOregonDetailedInfo } from "@/data/regions/northAmerica";
  ...
  const getDetailedInfo = (label: string) => {
    switch (location) {
      ...
      case "Asia Pacific (Tokyo)":
        return getTokyoDetailedInfo(label);
      case "Europe (Ireland)":
        return getIrelandDetailedInfo(label);
      case "US East (N. Virginia)":
        return getVirginiaDetailedInfo(label);
      case "US West (Oregon)":
        return getOregonDetailedInfo(label);
      default:
        switch (label) {
